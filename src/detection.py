...
class color_shape_detector:
    ...
    def __init__(self):
        ...
        tss = message_filters.ApproximateTimeSynchronizer([self.image_sub, self.depth_sub],10,0.05)
    ...
    def callback(self,ros_color, ros_depth):
        ...
        for color in self.colors:
            ...
            inImg = cv2.resize(self.bridge.imgmsg_to_cv2(ros_color,"bgr8"),(320,240))
            #depth encoding is "16UC1" rostopic echo /camera/depth/image_raw --noarr shows this encoding
            inDepth = self.bridge.imgmsg_to_cv2(ros_depth, "8UC1")
